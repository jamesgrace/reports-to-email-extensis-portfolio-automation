...
:exclamation: API Token will need to be granted Administrator level Role membership to at least one Catalog in order to be permitted access to the various REST API Reports.
